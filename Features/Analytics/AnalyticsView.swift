...
private extension AnalyticsView {
    ...
    func axisLabel(for date: Date) -> String {
        AnalyticsViewDataBuilder.makeAxisLabel(for: date, period: selectedPeriod)
    }
...
private struct AnalyticsMonthPickerSheet: View {
    ...
    private var yearOptions: [Int] {
        ...
        return Array((currentYear - AppLimits.yearPickerPastRange)...(currentYear + AppLimits.yearPickerFutureRange))
    }
