...
private extension EditPaymentFieldView {
    ...
    var inputView: some View {
        ...
        case .type:
            if sortedTemplates.isEmpty {
                Text(MessageCatalog.templateMissingDescription)
                    .font(.subheadline)
                    .foregroundStyle(.secondary)
    ...
    var sheetHeight: CGFloat {
        switch field {
        case .amount:
            return GameChargeDetailLayout.amountSheetHeight
        case .type:
            return GameChargeDetailLayout.typeSheetHeight
        case .date:
            return GameChargeDetailLayout.dateSheetHeight
        case .memo:
            return GameChargeDetailLayout.memoSheetHeight
        }
    }
...
private enum GameChargeDetailLayout {
    static let amountSheetHeight: CGFloat = 180
    static let typeSheetHeight: CGFloat = 420
    static let dateSheetHeight: CGFloat = 440
