...
struct SubscriptionDetailView: View {
    ...
    var body: some View {
        ...
        .alert("保存できませんでした", isPresented: saveErrorPresented) {
            ...
            Text(saveErrorMessage ?? "変更を保存できませんでした。もう一度お試しください。")
        }
...
private extension SubscriptionDetailView {
    ...
    func persistChanges() -> Bool {
        do {
            ...
            saveErrorMessage = "変更を保存できませんでした。もう一度お試しください。"
            return false
        }
    }
...
private extension SubscriptionInlineEditSheet {
    ...
    var inputView: some View {
        ...
        case .startDate:
            DatePicker("", selection: $startDate, displayedComponents: .date)
                ...
                .environment(\.locale, Locale(identifier: "ja_JP"))
                .environment(\.calendar, ViewDataCommon.mondayFirstCalendar)
    ...
    var sheetHeight: CGFloat {
        switch field {
        case .price:
            return SubscriptionDetailLayout.priceSheetHeight
        case .billingType:
            return SubscriptionDetailLayout.billingTypeSheetHeight
        case .renewalInterval:
            return SubscriptionDetailLayout.renewalIntervalSheetHeight
        case .startDate:
            return SubscriptionDetailLayout.startDateSheetHeight
        case .memo:
            return SubscriptionDetailLayout.memoSheetHeight
        }
    }
    ...
    func save() {
        ...
        case .memo:
            subscription.memo = memo.nilIfTrimmedEmpty
        }
...
private enum SubscriptionDetailLayout {
    static let priceSheetHeight: CGFloat = 180
    static let billingTypeSheetHeight: CGFloat = 280
    static let renewalIntervalSheetHeight: CGFloat = 220
    static let startDateSheetHeight: CGFloat = 440
    static let memoSheetHeight: CGFloat = 300
}
