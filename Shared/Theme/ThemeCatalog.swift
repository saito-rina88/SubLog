...
// Provides static theme definitions used by ThemeManager and theme-related views.
enum ThemeCatalog {
    ...
    static let defaultTheme: AppTheme = allThemes.first(where: { $0.id == "mint" }) ?? allThemes[0]
}
