...
struct HistoryView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .alert("支払いを削除しますか？", isPresented: deleteAlertBinding) {
...
private extension HistoryView {
        ...
        HStack {
            ...
            HStack(spacing: 2) {
                ...
                Button {
                    ...
                    Text(monthPagerFormatter.string(from: selectedMonth))
                        .font(.headline)
                        .foregroundStyle(.secondary)
    ...
    var sectionHeaderFormatter: DateFormatter {
    ...
    var monthPagerFormatter: DateFormatter {
        let formatter = DateFormatter()
        formatter.locale = Locale(identifier: "ja_JP")
        formatter.dateFormat = "yyyy年M月"
        return formatter
...
private struct MonthPickerView: View {
    ...
    init(selectedMonth: Binding<Date>, isPresented: Binding<Bool>) {
        ...
        self.years = Array((nowYear - 10)...nowYear).reversed()
    }
